...
class recenttopics_module
{
	...
	function main($id, $mode)
	{
		...
		if ($request->is_set_post('submit'))
		{
			...
			$rt_persistent_display = $request->variable('rt_persistent_display', false);
			$config->set('rt_persistent_display', $rt_persistent_display);
		...
		$template->assign_vars(array(
			...
			'RT_PERSISTENT_DISPLAY' => isset($config['rt_persistent_display']) ? $config['rt_persistent_display'] : false,
